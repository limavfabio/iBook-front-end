...
# 📖 VenomPrecision <a name="about-project"></a>

**VenomPrecision** is a website that lists paintball game products and accessories.
...
- **Create and manage your paintball items**
- **Reserve items with city and date**
...
You need a machine with Ruby and Node.js installed. You also need to have PostgreSQL installed and running.
...
```sh
  git clone https://github.com/limavfabio/VenomPrecision-front-end.git
```
...
- [ ] **Full fledged login and account management**
- [ ] **App wide search**
- [ ] **See and follow other profiles**
...
I would like to thank the Microverse team for the code review and the support during this project.

The design of this project was based on the work by Murat Korkmaz on Behance. You can find it [here](https://www.behance.net/gallery/26425031/Vespa-Responsive-Redesign).
